...
2. DOCUMENT_RETRIEVAL - User wants information from policy documents
   Keywords: what is covered, explain, benefits, terms, conditions, eligibility, coverage details
   
3. GENERAL_INSURANCE - General insurance questions that need document search
   Default category if not premium calculation
...
Classification (respond with only the category name):"""
    ...
    def classify_intent(self, query: str) -> str:
        ...
        try:
            ...
            valid_intents = ['PREMIUM_CALCULATION', 'DOCUMENT_RETRIEVAL', 'GENERAL_INSURANCE']
    ...
    def route_query(self, query: str, **kwargs):
        ...
        Args:
            query: User's query
            **kwargs: Additional parameters (chroma_db_dir, k, doc_type_filter, etc.)
